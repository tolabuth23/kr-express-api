...
import ValueImportRateInterface from '../../importRate/interfaces/valueImportRate.interface'
import { IImportRate } from './Interfaces/currencyIImportRate.interface'
...
export default class Currency {
  ...
  constructor(props: {
    ...
    cod: number
    currencyRate: number
    category: ValueImportRateInterface
    userRole: string
  }) {
